...
public class MagicHandBackup : MonoBehaviour
{
    [Header("Visuals")]
    ...
    public void UpdateHand(List<Vector3> keypoints)
    {
        ...
        {
            Debug.LogWarning("Mismatch between keypoints (" + keypoints.Count + ") and physics bodies (" + keypointBodies.Count + ")! ");
            return;
        }
